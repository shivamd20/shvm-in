...
function VoiceSession() {
    ...
    return (
        <div className="min-h-screen bg-black text-zinc-100 flex flex-col items-center justify-center p-4 selection:bg-accent/20 relative overflow-hidden">
          ...
          ${isListening ? 'bg-green-500 scale-125' :
            ...
            <div className="relative z-10 max-w-md w-full flex flex-col items-center gap-12 transition-all duration-500" style={{ transform: isDebugOpen ? "translateX(-150px)" : "translateX(0)" }}>
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    {error && (
                        <div className="text-red-400 text-sm font-mono bg-red-900/20 px-3 py-1 rounded border border-red-900/50 animate-in fade-in slide-in-from-top-2">
                            {error}
                        </div>
                    )}
