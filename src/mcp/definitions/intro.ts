...
export const introDefinition = {
    name: "intro",
    description: "Get a concise introduction to Shivam Dwivedi — current role, engineering style, systems built, and career intent. Best used as a first contact tool.",
    schema: z.object({}),
    handler: async () => {
