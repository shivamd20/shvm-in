...
export const systemDesignProbeDefinition = {
    name: "system_design_probe",
    description: "Provide architecture-first answers about Shivam's system design depth. Input a topic (e.g., 'distributed database', 'real-time collaboration', 'edge computing') to get relevant systems, architecture choices, tradeoffs, and seniority signals.",
    schema: z.object({
