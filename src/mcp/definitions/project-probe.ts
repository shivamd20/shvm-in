...
export const projectProbeDefinition = {
    name: "project_probe",
    description: "Get detailed information about a specific project — problem solved, architecture summary, complexity level, ownership, and notable decisions. Use fuzzy matching on project name.",
    schema: z.object({
